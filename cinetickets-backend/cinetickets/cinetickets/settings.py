"""
Django settings for cinetickets project.
...
SECRET_KEY = 'django-insecure-b+*fwpkp)u9&s0t3txxv3+-k=_pk8eohf_s!%w*ecgfhyl^(@_'
...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "cinetickets-backend-glcg.onrender.com",
    "cinetickets-frontend.vercel.app",
    "192.168.0.17",
]
...
WSGI_APPLICATION = 'cinetickets.wsgi.application'
...
if RENDER_EXTERNAL_HOSTNAME:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": config("POSTGRES_DB", default="cinetickets"),
